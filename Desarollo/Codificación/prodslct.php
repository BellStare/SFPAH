...
<body>
    ...
    <div align="center">
        <h1 style="color: white;">Selección de productos</h1>
    </div>

    <div align="center">
        <form actions="" method="get">
            <input class="buscador-productos" type="text" name="busqueda"> <br>
	...
	?>
		<div class="contenedor_productos">
			...
			<div>
			    <img src="<?php echo $consulta[$i]["img"]; ?>">
			</div>
			<div>
    ...
    <table>
        <tr>
            ...
            <th style="width:10%"><a class="boton-limpiar" href="prodslct.php?accion=vacio">Limpiar</a></th>
        </tr>
        <?php
        ...
        ?>
            <tr>
                ...
                <td>
                    <a class="boton-quitar" href="prodslct.php?accion=eliminar&eliminarcode=<?php echo $item["vai_cod"]; ?>">Quitar</a>
                </td>
            </tr>
            <?php
        ...
        <tr style="background-color:#f3f3f3">
            ...
            <td><a class="redireccion" href="prodslct.php?accion=pagar">Buscar en tienda</a></td>
        </tr>
    </table>
    <?php
    } else {
